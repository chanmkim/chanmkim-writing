      ...
      <div className="content-sections">
        ...
        <section className="content-section">
          ...
          <div className="section-content">
            ...
            <p>결국 만물은 양자스핀의 값을 가지며, 트랜지스터 역시 이진법으로 구현되기 때문에 &ldquo;프로그램&rdquo;이란 만물을 모사할 수 있는 하나의 모듈이 될 수 있습니다.</p>
            ...
            <div className="example-box">
              <h4>예시: 유튜브 알고리즘</h4>
              <p>&ldquo;버츄얼 아이돌&rdquo;이라는 키워드가 달린 영상은 홈화면에 노출될 가중치를 둔다... 라는 규칙을 부여할 수 있습니다.</p>
                              <p>그런데 이 규칙은 개발자가 언제든지 수정할 수 있습니다. 여름인 경우 &ldquo;태국&rdquo;이라는 키워드에 가중치를 넣어 특정 국가에 대한 마케팅을 해볼 수 있습니다.</p>
            </div>
...
export const writing1Meta: Writing = {
  ...
  readTime: '8분',
  author: '김찬민',
  content: '지난 3년 간 정말로 다양한 경험을 했습니다. 해외를 많이 다니고 취미가 많았다는 의미가 아닙니다. 정말로 다양한 시도들을 하였습니다. 시스템화된 조직에서 PM으로 일도 해보았고, 혼자서도 개인프로젝트를 0부터 1까지 만들어 보았습니다. 크리에이터 이코노미를 경험하고 싶어 작곡가에게 직접 음향을 만지는 법을 공부해봤고 새벽에 일어나 블렌드3D, 애프터이펙트를 만지고 다루는 법도 한번 시험해봤습니다. 너무나 많은 학습을 하면서 더욱더 웹3에 대한 생각이 공고해졌습니다. 그리고 이 분야에 내가 왜 가야하는지에 대해서 생각하게 되었습니다.'
}
